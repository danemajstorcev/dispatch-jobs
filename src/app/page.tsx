...
export const metadata: Metadata = {
  ...
  description:
    "Browse dispatcher, freight broker, and logistics coordinator jobs. Remote, hybrid, and on-site positions. Updated daily.",
};
  ...
  return (
    <>
      ...
      <main>
        <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-16 sm:py-20 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto mb-10">
              The only job board built for freight dispatchers, logistics
              coordinators, and supply chain professionals. Remote, hybrid, and
              on-site roles — all in one place.
            </p>
        ...
        <section
          id="categories"
          className="bg-slate-50 border-b border-slate-200 py-8"
        >
        ...
        <section className="bg-brand-600 py-12 sm:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-brand-100 mb-6 text-sm sm:text-base">
              Post your job and reach thousands of qualified logistics
              professionals.
            </p>
            <Link
              href="/auth/signin"
